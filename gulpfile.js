...
function imgTask() {
  return src(imagePath).pipe(gulp.dest("public/images/"));
}
...
function watchTask() {
  ...
  gulp.watch(
    [cssPath, jsPath, cppPath, wasmJSPath, htmlPath],
    { interval: 1000 },
    parallel(cssTask, jsTask, wasmTask, copyHtml, imgTask, jsWorkerTask)
  );
