...
var wasmBinaryFile = 'maze_wasm.wasm';
...
function sendPlayerData(generation,done,coordinates){ dispatchEvent(new CustomEvent("gotCoordinates", {detail : {gen : generation, coord : UTF8ToString(coordinates), done : done}})); }
